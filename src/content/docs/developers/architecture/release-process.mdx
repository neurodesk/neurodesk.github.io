...
4. Create the GitHub release on [neurodesk/neurodesktop](https://github.com/neurodesk/neurodesktop/releases), tagged with the build date (for example `2026-09-23`).
5. Summarise the main changes and add them to the [Release History](/overview/release-history/) using the [release history template](https://github.com/neurodesk/neurodesk.github.io/blob/main/.github/content-templates/release-history-template.md). Move the **Latest** badge to the new release.
6. Change `jupyterNeurodeskVersion` in [`src/config/neurodesktop.ts`](https://github.com/neurodesk/neurodesk.github.io/blob/main/src/config/neurodesktop.ts) to the new release. Every docker command, the Getting Started page, the release history and the citation examples read the version from this constant. Renovate also opens a PR for this bump once the GitHub release is published; close it if you have already made the change together with the release notes.
7. Commit all changes.
8. Tweet a quick summary of the changes and announce the new version: [https://masto.ai/@Neurodesk](https://masto.ai/@Neurodesk)
