...
sidebar:
  order: 7
# Release dates are level 2 headings; the New Features / Improvements / Bug
# Fixes headings inside each release are level 3. Cap the table of contents at
# level 2 so it lists release dates instead of repeating the same three
# subheadings once per release.
tableOfContents:
  maxHeadingLevel: 2
