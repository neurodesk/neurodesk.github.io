...
:::tip[Question not answered here?]
Ask on our [discussion forum](https://github.com/orgs/neurodesk/discussions), hosted on GitHub
Discussions. It is the fastest way to reach the Neurodesk community and the team, and your question
helps the next person who runs into the same thing.
:::
...
![Docker_troubleshooting](/docs/support/faq/Docker_troubleshooting.png)
...
![Docker_update](/docs/support/faq/Docker_update.png)
</details>
...
![Docker_WSL_correct](/docs/support/faq/Docker_WSL_correct.png)
...
![Docker_WSL_incorrect](/docs/support/faq/Docker_WSL_incorrect.png)
