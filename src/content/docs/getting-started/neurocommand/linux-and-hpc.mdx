...
NVIDIA-driven displays also need `--nv` for OpenGL GUIs. See [OpenGL GUIs on NVIDIA displays](/getting-started/neurocontainers/singularity/#opengl-guis-on-nvidia-displays) for setup and troubleshooting.
:::
