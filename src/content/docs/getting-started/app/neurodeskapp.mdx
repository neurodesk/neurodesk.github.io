...
![Engine selection screen showing Docker, Podman, and TinyRange options](/docs/getting-started/neurodeskapp/engine-options.png)
...
<TabItem label="TinyRange (no admin needed)">

**Use this if you do NOT have admin/root access.**

TinyRange is included with the Neurodesk App, so no separate install is needed on Windows and Linux.
