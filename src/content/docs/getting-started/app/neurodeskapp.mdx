...
After installing Podman, configure the Neurodesk App to use it before starting a local session:

1. Open the Neurodesk App's **Settings**.
2. Select **General** in the sidebar.
3. Under **Engine Options**, select **Podman**.
4. Click **Apply & restart**.

![Neurodesk App General settings with Podman selected under Engine Options](/docs/getting-started/neurodeskapp/settings-podman.png)
