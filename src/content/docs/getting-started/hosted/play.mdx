...
:::note
Neurodesk Play is free but comes with resource limits. For more intensive workloads, consider [installing Neurodesk locally](/getting-started/app/) or using one of our [other hosting options](/getting-started/hosted/).
:::
...
:::note[First-time access requires approval]
The US and Europe Play servers use your GitHub account to sign in. On your first login attempt, you will automatically be shown a registration form if your account has not yet been authorized. Submit the form; the average authorization time is 24 hours. Once approved, return and sign in with the same GitHub account.
:::
